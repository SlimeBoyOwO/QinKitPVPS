...
public class PvzEntity {
    ...
    private static final Map<Entity, List<Entity>> danceZombies = new HashMap<>();
    ...
    public static void setDanceZombies(Entity dancer, Entity... zombies) {
        List<Entity> palDancers = new ArrayList<>(Arrays.asList(zombies));
        danceZombies.put(dancer,palDancers);
    }
}
